...
setshowservices(false)
    services.map((item) => {
      if (item.id === id) {
        document.getElementById(item.id).classList.add("clicked");
      } else {
        document.getElementById(item.id).classList.remove("clicked");
      }
    });
  };
  ...
  return (
    ...
    <div className=" componant-padding   m-auto containerwidth flex-wrap mt-5">
      ...
      <div className="mt-5 p-3 text-center text-light binkbg ">
        ...
        <div className="mt-5">
          <img src={image} alt=" " />
          <div className="binkbg text-light ps-3">
      ...
      {showservices ? (
        ...
        <div className="">
            <h5 className="mt-5 ">
            Here are a few ways in which you can implement Textmagic’s online SMS services for your fitness club:
            ...
            <p>Acknowledge clients for coming to the club. Send personalized gym SMS to congratulate members for showing up at personal training sessions. This will make them feel special, empowered, and proud. Use your Textmagic SMS scheduler to send periodic encouragement texts to your loyal clients.</p>
            ...
            .map((item) => {
              return (
                <div>
                  ...
                  <p>Purpose: to analyze the phenomenon of psychological and psycho-physical training as part of physical education of students. Material: literary sources about problem investigation. Results: are given and analyzed a number of factors that determine the need for higher education in the special psychological and psycho-physical preparation for professional work.</p>
...
<p>phenomenon of psychological and psycho-physical</p>
                ...
                <div> The question of psychological and psycho-physical preparation of students for professional work in the structure of physical education has considered. The difference has shown in the proposed concept of "psychological and psycho-physical training" known in physical education concept of "professionally applied physical training" and "psycho-physical preparation".</div>
                </div>
              );
            })}
        </div>
